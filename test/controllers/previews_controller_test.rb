...
class PreviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preview" do
    assert_difference('Preview.count') do
      post previews_url, params: { preview: { comment: @preview.comment, rating: @preview.rating } }
    end
  ...
  test "should update preview" do
    patch preview_url(@preview), params: { preview: { comment: @preview.comment, rating: @preview.rating } }
